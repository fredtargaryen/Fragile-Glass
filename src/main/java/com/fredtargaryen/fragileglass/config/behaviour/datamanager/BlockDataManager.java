...
public class BlockDataManager extends DataManager<BlockState, ArrayList<FragilityData>> {
    ...
    private static final String[] defaultFileData = new String[] {
            ...
            "@  they are listed. If a line adds an existing behaviour to a previous one it will overwrite it.\n",
            "@* If a block has a behaviour but no break behaviour, the crash behaviour will execute multiple times.\n",
            "@  To ensure a behaviour triggers only once, add a behaviour that gets rid of the blockstate, such as\n",
            "@  break or change.\n",
